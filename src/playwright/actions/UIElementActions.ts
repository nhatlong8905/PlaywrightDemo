...
export default class UIElementActions {
   ...
   * @returns
   */
  public async waitTillInvisible(sec: number=3) {
    await this.getLocator().waitFor({ state: "hidden", timeout: sec * 1000 });
    return this;
  }
   ...
   * @returns
   */
  public async waitTillDetached(sec: number=3) {
    await this.getLocator().waitFor({ state: "detached", timeout: sec * 1000 });
    return this;
  }
   ...
   * @returns
   */
  public async waitTillVisible(sec: number=3) {
   ...
   * @returns
   */
  public async waitForPresent(sec: number=3) {
    await this.getLocator().waitFor({ state: "attached", timeout: sec * 1000  });
    return this;
  }
